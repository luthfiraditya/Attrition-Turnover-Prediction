...
# attrition_prediction documentation build
...
from attrition_prediction import __version__ as release

# -- Project information -----------------------------------------------------

project = "attrition_prediction"
author = "Kedro"
...
htmlhelp_basename = "attrition_predictiondoc"
...
latex_documents = [
    (
        master_doc,
        "attrition_prediction.tex",
        "attrition_prediction Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "attrition_prediction",
        "Project attrition_prediction codebase.",
        "Data-Science",
    )
]
